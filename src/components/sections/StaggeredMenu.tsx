  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between px-4 py-4 md:px-8 md:py-6 bg-transparent pointer-events-none z-20"
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full flex flex-col p-[5.25em_1.25em_1.5em_1.25em] sm:p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto"
          style={{
            background: colors?.[0] || "#f6bd60",
